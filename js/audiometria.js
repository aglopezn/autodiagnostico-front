...
function addExamAnswers(){
  let questions = $('#form-audiometria input');
...
function updateFormState(estado){
  ...
  return jQuery.ajax({
    url: `http://${_DOMAIN_SERVICES}/autodiagnostico-rest-services/formstservice/updatestate/${sessionStorage.getItem('idUsuario')}/${estado}/${_AUDIOMETRIA}`,
    contentType: "application/json",
    method: "PUT",
    crossOrigin: true,
  })
