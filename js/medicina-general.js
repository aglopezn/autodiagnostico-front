...
function getFormstate(){
  ...
  return jQuery.ajax({
    url: `http://${_DOMAIN_SERVICES}/autodiagnostico-rest-services/formstservice/getformstfield/${idUser}/${_MEDICINA_GENERAL}`,
...
function validateAnswers(){
  if ($('#12').val() == '26' && $('#17').val() == '36' && $('#18').val() == '38' && $('#19').val() == '42'){
    return 'NO_APROBADO';
  }
  if ($('#12').val() != '26' && $('#17').val() != '36' && $('#18').val() != '38' && $('#19').val() != '42' &&
      $('#13').val() == '29' && $('#14').val() == '31' && $('#15').val() == '33'){
    return 'APROBADO';
  }
